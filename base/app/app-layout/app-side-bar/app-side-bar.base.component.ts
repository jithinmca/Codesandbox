...
export class AppSideBarBaseComponent {
  ...
  constructor(public bs: AppLayoutBaseService, public translate: TranslateService, public utilBase: AppUtilBaseService,public router: Router) {
  }
